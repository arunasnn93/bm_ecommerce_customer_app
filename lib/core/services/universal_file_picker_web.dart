...
/// Exported functions for conditional import
Future<FileData?> _pickImageWebImpl() async {
  return await UniversalFilePickerWeb.pickImage();
}

Future<FileData?> _pickFileWebImpl() async {
  return await UniversalFilePickerWeb.pickFile();
}
